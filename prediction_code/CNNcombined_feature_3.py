...
trainb=train.reshape(rows1,15,20,2)
...
testb=test.reshape(rows2,15,20,2)
...
from keras.layers import Conv3D, MaxPooling3D, Dense, Flatten, Reshape
def model():
     model = models.Sequential()
     model.add(Reshape((15,20,2,1),input_shape=(15,20,2)))
     model.add(Conv3D(20,(1,1,1),activation='tanh'))
     model.add(MaxPooling3D((1,1,1)))
     model.add(Conv3D(50,(1,1,1),activation='tanh'))
     model.add(MaxPooling3D((1,1,1)))
     model.add(Flatten())
